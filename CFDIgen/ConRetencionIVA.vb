...
Public Class ConRetencionIVA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CFDIgen.ConRetencionIVA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConRetencionIVA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ConRetencionIVA = New ConRetencionIVA()
        rpt.Site = Me.Site
        Return rpt
    End Function
